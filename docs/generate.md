...
```bash
uvx --with copier-templates-extensions copier copy --trust "gh:Bullish-Design/templateer" /path/to/your/new/project
```
...
🎤 [None]: bullishdesignengineering@gmail.com
```
...
🎤 [bullishdesignengineering@gmail.com]: 
```
